 ...
 */
    public function __construct(array $configuration, $plugin_id,
                                $plugin_definition, HelloWorldSalutationService $salutation) {
    ...
    public function build() {
        ...
        if($this->configuration['enabled'] == 1) {
            return [
...
feature.'),
    ...
    public function blockValidate($form, FormStateInterface $form_state)
    {
        ...
        if ($enabled != 1) {
            $form_state->setErrorByName('enabled', $this->t('
Please enable the field'));
        }
    }
